...
async function prune( { spinner, debug } ) {
	...
	spinner.info(
		'WARNING! This will remove Docker containers, volumes, images, and networks associated with the WordPress instance.'
	);
	...
	spinner.text = 'Removing containers, volumes, images, and networks.';

	await exec('docker system prune -af');

	spinner.text = 'Removed containers, volumes, images, and networks.';
};